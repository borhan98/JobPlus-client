...
const MyJob = ({ job, myjobs, setMyJobs }) => {
  ...
  return (
    <div className="grid gap-2 grid-cols-1 md:grid-cols-12 p-4 bg-base-200 items-center border-b border-l border-r mb-8 rounded-md">
      <div className="col-span-2 flex gap-2 md:gap-0 items-center md:flex-col">
        <h5>Job Author:</h5>
        <h3 className="text-lg lg:text-xl text-center font-medium">{job_author}</h3>
      </div>
      ...
      <div className="col-span-3 flex gap-2 flex-col-reverse md:flex-col space-y-1">
